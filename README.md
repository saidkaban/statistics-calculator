...
If a list containing less than 9 elements is passed into the function, the function raises a `ValueError` exception with the message: "List must contain nine numbers." The values in the returned dictionary are be lists and not Numpy arrays.
